...
public class CityMarker extends CommonMarker {
	...
	public CityMarker(Feature city, PImage image) {
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		pg.rect(x, y-9-39, Math.max(pg.textWidth(name), pg.textWidth(pop)) + 6, 39);
		pg.fill(0, 0, 0);
		pg.textAlign(PConstants.LEFT, PConstants.TOP);
		pg.text(name, x+3, y-9-33);
		pg.text(pop, x+3, y - 9 -18);
